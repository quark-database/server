...
public class OpenDebugCommand extends Command {
    public OpenDebugCommand() {
        super(new UniqueList<>("open-debug", "show-debug", "open-debug-window", "show-debug-window", "show-debug-window", "show-debug-dialog"),
    ...
    public void action(CommandArguments arguments) {
        var debugDialog = switch(arguments.get("named")) {
            ...
            case "instruction-parser" -> new InstructionParserDebugFrame(loop.getServer());
