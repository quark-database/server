...
/**
 * This class represents the digit count constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("digit count"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("digit count").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class DigitCountConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the digit count constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("digit count");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public DigitCountConstructor() {
        super(
                ...
                returns("count of digits of the integer", "int"),
    ...
    /**
     * Invokes the @digit count constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new IntegerEntity(Integers.countDigits(arguments.getInt("integer")));
    }
}
