...
/**
 * This class represents the right trim constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("right trim"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("right trim").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class RightTrimConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the right trim constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("right trim");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public RightTrimConstructor() {
        super(
                ...
                returns("the right trimmed string", "str"),

                required("string to trim", "str")
        );
    }

    /**
     * Invokes the @right trim constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(arguments.getString("string to trim").transform(Strings::rightTrim));
    }
}
