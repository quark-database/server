...
/**
 * This class represents the trim constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("trim"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("trim").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class TrimConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the trim constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("trim");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public TrimConstructor() {
        super(
                ...
                returns("the trimmed string", "str"),
    ...
    /**
     * Invokes the @trim constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(arguments.getString("string to trim").trim());
    }
}
