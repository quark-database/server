...
/**
 * This class represents the lower constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("lower"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("lower").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class LowerConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the lower constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("lower");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public LowerConstructor() {
        super(
                ...
                required("string to lowercase", "str")
        );
    }

    /**
     * Invokes the @lower constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(arguments.getString("string to lowercase").toLowerCase());
    }
}
