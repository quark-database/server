...
public class RepeatConstructor extends EntityConstructor {
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        var stringToRepeat = arguments.getString("string to repeat");
        var timesToRepeat = arguments.getInt("times to repeat");

        return new StringEntity(stringToRepeat.repeat(timesToRepeat));
    }
}
