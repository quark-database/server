...
import ru.anafro.quark.server.databases.instructions.entities.exceptions.BadInstructionEntityConstructorArgumentException;
...
public class InstructionEntityConstructorArgument {
    ...
    public void eval() {
        if(!hasEntityComputed() && hasConstructorToCompute()) {
            ...
            throw new BadInstructionEntityConstructorArgumentException();
        }
    }
}
