...
import ru.anafro.quark.server.database.language.InstructionList;
...
import ru.anafro.quark.server.database.language.entities.constructors.*;
import ru.anafro.quark.server.database.language.entities.constructors.columns.*;
import ru.anafro.quark.server.database.language.entities.constructors.mapping.types.Conditions;
import ru.anafro.quark.server.database.language.entities.constructors.mapping.types.Dates;
import ru.anafro.quark.server.database.language.entities.constructors.modifiers.*;
import ru.anafro.quark.server.database.language.exceptions.InstructionSyntaxException;
import ru.anafro.quark.server.database.language.instructions.*;
import ru.anafro.quark.server.database.language.types.*;
