...
/**
 * This class represents the capitalize constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("capitalize"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("capitalize").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class CapitalizeConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the capitalize constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("capitalize");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public CapitalizeConstructor() {
        super(
                ...
                returns("capitalized string", "str"),

                required("string to capitalize", "str")
        );
    }

    /**
     * Invokes the @capitalize constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(Strings.capitalize(arguments.getString("string to capitalize")));
    }
}
