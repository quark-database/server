...
/**
 * This class represents the is string empty constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("is string empty"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("is string empty").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class IsStringEmptyConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the is string empty constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("is string empty");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public IsStringEmptyConstructor() {
        super(
                ...
                returns("is the string empty", "boolean"),
    ...
    /**
     * Invokes the @is string empty constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new BooleanEntity(arguments.getString("string").isEmpty());
    }
}
