...
/**
 * This class represents the left trim constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("left trim"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("left trim").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class LeftTrimConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the left trim constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("left trim");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public LeftTrimConstructor() {
        super(
                ...
                returns("the left trimmed string", "str"),
    ...
    /**
     * Invokes the @left trim constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(arguments.getString("string to trim").transform(Strings::leftTrim));
    }
}
