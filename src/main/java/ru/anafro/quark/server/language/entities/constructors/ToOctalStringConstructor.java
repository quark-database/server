...
/**
 * This class represents the "to octal string" constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("to octal string"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("to octal string").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class ToOctalStringConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the "to octal string" constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("to octal string");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public ToOctalStringConstructor() {
        super(
                ...
                returns("the octal string", "str"),

                required("integer to convert to octal string", "int")
        );
    }

    /**
     * Invokes the @to octal string constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(Integer.toOctalString(arguments.getInt("integer to convert to octal string")));
    }
}