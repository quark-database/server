...
/**
 * This class represents the "to binary string" constructor of Quark QL.
 * <br><br>
 * <p>
 * Note that you should not create instances of this class
 * by your own. Instead, use {@code Quark.constructors().get("to binary string"); }
 ...
 * <pre>
 * {@code
 * Quark.constructors().get("to binary string").getSyntax();
 * }
 * </pre>
 *
 ...
 * @since Quark 1.1
 */
public class ToBinaryStringConstructor extends EntityConstructor {

    /**
     * Creates a new instance of the "to binary string" constructor
     * representing object.
     * <br><br>
     * <p>
     * Note that you should not create instances of this class
     * by your own. Instead, use Quark.constructors().get("to binary string");
     * to get an instance of this class.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
    ...
    public ToBinaryStringConstructor() {
        super(
                ...
                returns("the binary string", "str"),

                required("integer to convert to binary string", "int")
        );
    }

    /**
     * Invokes the @to binary string constructor programmatically with arguments.
     * <br><br>
     * <p>
     * You can check out the syntax of this constructor by running
     * <pre>
    ...
    protected Entity invoke(InstructionEntityConstructorArguments arguments) {
        return new StringEntity(Integer.toBinaryString(arguments.getInt("integer to convert to binary string")));
    }
}
